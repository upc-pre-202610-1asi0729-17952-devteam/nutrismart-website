...
/**
 * @module termsLang
 * @description Syncs the Terms page content visibility with the active language.
 * Toggles `lang-en` / `lang-es` on `<body>` so that `.terms-en` and `.terms-es`
 * blocks are shown or hidden via CSS.
 */
(function () {
  /**
   * Applies the correct language class to `document.body`.
