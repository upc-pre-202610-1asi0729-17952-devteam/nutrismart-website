/**
 * @fileoverview NutriSmart Internationalization (i18n) module.
...
const translations = {
  ...
  en: {
    ...
    hero3_sub:     'Watch how NutriSmart transforms your nutrition journey',
    ...
    fh_subtitle:    'NutriSmart goes beyond calorie counting. Context is everything.',
    ...
    fh3_desc:  'Hot day? Cold night? NutriSmart adjusts your meal recommendations in real time to match your local weather conditions.',
    ...
    faq1_q: 'What makes NutriSmart different from other nutrition apps?',
    faq1_a: 'NutriSmart is the only platform that combines visual food analysis (Smart Scan), real-time weather recommendations, travel mode with local dish suggestions, and pantry-based recipe ideas, all tailored to your individual health profile and dietary restrictions.',

    faq2_q: 'How does the "Smart Scan" photo analysis work?',
    faq2_a: 'Simply take a photo of your plate or a restaurant menu. NutriSmart uses computer vision to identify the food items and cross-references our nutritional database to estimate calories and macros. You review and confirm the result before it\'s saved to your log.',
    ...
    faq4_q: 'Can I use NutriSmart if I have allergies or medical restrictions?',
    ...
    /* --- ABOUT US PAGE --- */
    about_hero_title: 'We are NutriSmart',
    about_hero_desc:  'Eating well shouldn\'t be a challenge. At NutriSmart, we transform dietary management by combining nutritional tracking with smart contextual analysis. We don\'t just count calories — we understand your environment so you can reach your fitness goals, no matter where you are or what the weather is today.',
    ...
    footer_copy:     '© 2026 NutriSmart. Designed by the NutriSmart Team',
  },
  ...
  es: {
    ...
    hero3_sub:     'Mira cómo NutriSmart transforma tu experiencia nutricional',
    ...
    fh_subtitle: 'NutriSmart va más allá de contar calorías. El contexto lo es todo.',
    ...
    fh3_desc:  '¿Día caluroso? ¿Noche fría? NutriSmart ajusta tus recomendaciones de comidas en tiempo real según el clima de tu ubicación.',
    ...
    faq1_q: '¿Qué hace diferente a NutriSmart de otras aplicaciones de nutrición?',
    faq1_a: 'NutriSmart es la única plataforma que combina análisis visual de alimentos (Smart Scan), recomendaciones por clima en tiempo real, modo viaje con sugerencias de platos locales e ideas de recetas basadas en tu despensa, todo adaptado a tu perfil de salud y restricciones dietéticas.',

    faq2_q: '¿Cómo funciona el análisis de fotos "Smart Scan"?',
    faq2_a: 'Simplemente toma una foto de tu plato o del menú de un restaurante. NutriSmart usa visión por computadora para identificar los alimentos y cruza los datos con nuestra base nutricional para estimar calorías y macros. Tú revisas y confirmas el resultado antes de guardarlo en tu registro.',
    ...
    faq4_q: '¿Puedo usar NutriSmart si tengo alergias o restricciones médicas?',
    ...
    /* --- ABOUT US --- */
    about_hero_title: 'Somos NutriSmart',
    about_hero_desc:  'Comer bien no debería ser un reto. En NutriSmart transformamos la gestión alimentaria combinando el seguimiento nutricional con el análisis inteligente del contexto. No solo contamos calorías: entendemos tu entorno para que puedas alcanzar tus metas, sin importar dónde estés ni qué tiempo haga hoy.',
    ...
    footer_copy:     '© 2026 NutriSmart. Diseñado por el equipo NutriSmart',
  }
};
